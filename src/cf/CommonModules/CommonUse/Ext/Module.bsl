...
// Returns enumeration metadata name by enumeration value.
//
Function EnumerationValueByValuePresentation(ValuePresentation) Export
	
	EnumValues = ValuePresentation.Metadata().EnumValues;
	For Each Item In EnumValues Do
		If Item.Synonym = String(ValuePresentation) Then
			Return Item.Name; 	
		EndIf;
	EndDo;	
