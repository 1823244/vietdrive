...
Function CommonSettings() Export
	...
	// Use subsystems.
	// 1. Contact information subsystem
	// 2. Print subsystem - standard printed form for the certificate issue application.
	// 3. Subsystem Work with counterparties - check TIN, personal accounts by BIC.
