...
Function GetFiveDaysCalendar() Export
	...
	If BusinessCalendar = Undefined Then
		...
		WriteLogEvent(NStr("en='Cannot fill in the work schedule data for the company.';ru='Неудалось заполнить данные граффиков работы для организации.'"), 
			EventLogLevel.Error, , , DetailErrorDescription(ErrorInfo()));
...
EndFunction // GetFiveDaysCalendar()
