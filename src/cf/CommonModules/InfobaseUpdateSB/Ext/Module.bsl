...
//(7) Procedure creates a work schedule based on the business calendar the "Five-day working week" template
// 
...
EndProcedure // CreateFiveDaysCalendar()
...
Procedure FillContractsForms()
	...
	Templates = New Array(3);
	Templates[0] = PurchaseAndSaleContractTemplate;
	Templates[1] = ServicesContractTemplate;
	Templates[2] = SupplyContractTemplate;
	
	LayoutNames = New Array(3);
	LayoutNames[0] = "PurchaseAndSaleContractTemplate";
	LayoutNames[1] = "ServicesContractTemplate";
	LayoutNames[2] = "SupplyContractTemplate";
	
	Forms = New Array(3);
	Forms[0] = Catalogs.ContractForms.PurchaseAndSaleContract.Ref.GetObject();
	Forms[1] = Catalogs.ContractForms.ServicesContract.Ref.GetObject();
	Forms[2] = Catalogs.ContractForms.SupplyContract.Ref.GetObject();
...
Procedure FirstLaunch() Export
	...
	Calendar = SmallBusinessServer.GetFiveDaysCalendar(); 
...
Procedure DefaultFirstLaunch() Export
	...
	OurCompany.BusinessCalendar      	= SmallBusinessServer.GetFiveDaysCalendar();
	OurCompany.Write();
