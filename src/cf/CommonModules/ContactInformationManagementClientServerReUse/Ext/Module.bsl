...
Function TypesOfAddressingAddresses() Export
	...
	Result.Add(ObjectStringAddress("1010", NStr("en='House';ru='дом'"),          1, 1));
	Result.Add(ObjectStringAddress("1020", NStr("en='Ownership';ru='Владение'"),     1, 2));
	Result.Add(ObjectStringAddress("1030", NStr("en='Home-ownership';ru='Домовладение'"), 1, 3));
	
	Result.Add(ObjectStringAddress("1050", NStr("en='Block';ru='блок'"),     2, 1));
	Result.Add(ObjectStringAddress("1060", NStr("en='Construction';ru='строительство'"),   2, 2));
	Result.Add(ObjectStringAddress("1080", NStr("en='Email';ru='Письмо'"),     2, 3));
	Result.Add(ObjectStringAddress("1070", NStr("en='Construction';ru='Сооружение'"), 2, 4));
