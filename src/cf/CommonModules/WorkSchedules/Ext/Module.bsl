...
Procedure OnAddUpdateHandlers(Handlers) Export
	...
	Handler.Procedure = "WorkSchedules.CreateFiveDaysCalendar";
...
Procedure FillWorkSchedulesFillingSettings() Export
	...
	BusinessCalendar5D = CalendarSchedules.FiveDaysBusinessCalendar();
	
	If BusinessCalendar5D = Undefined Then
	...
	While Selection.Next() Do
		...
		If Not ValueIsFilled(Selection.BusinessCalendar) Then
			// Set the calendar of the five days
			WorkScheduleObject.BusinessCalendar = BusinessCalendar5D;
		EndIf;
