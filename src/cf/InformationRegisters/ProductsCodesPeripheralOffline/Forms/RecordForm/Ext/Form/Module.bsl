...
Procedure FillCheckProcessingAtServer(Cancel, CheckedAttributes)
	...
	If Selection.Next() // Barcode is already written in the database
		...
		ErrorDescription = NStr("en='Such code is already assigned for products and services %ProductsAndServices%';ru='Такой код уже назначен для номенклатуры %ProductsAndServices%'");
