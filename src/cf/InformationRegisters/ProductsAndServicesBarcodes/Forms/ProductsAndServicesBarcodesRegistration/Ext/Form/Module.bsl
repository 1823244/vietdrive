...
Procedure FillCheckProcessingAtServer(Cancel, CheckedAttributes)
	...
	If Selection.Next() Then // Barcode is already written in the database
		...
		ErrorDescription = NStr("en='Such barcode is already specified  for products and services %ProductsAndServices%';ru='Такой штрихкод уже назначен для номенклатуры %ProductsAndServices%'");
