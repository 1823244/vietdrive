...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.SerialNumbersUpdatePeriodAction.ChoiceList.Add(NStr("en='Generate numbers in order';ru = 'Сгенерировать номера в порядке очереди'"));
	Items.SerialNumbersUpdatePeriodAction.ChoiceList.Add(NStr("en='Fill with numbers frome the range';ru = 'Заполнить номерами из диапазона'"));
