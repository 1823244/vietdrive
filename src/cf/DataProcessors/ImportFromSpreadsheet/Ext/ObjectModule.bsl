...
Procedure CheckDuplicatesOfRows(Cancel) Export 
	...
	If Not QueryResult.IsEmpty() Then
		...
		While QueryResultSelection.Next() Do
			MessageText = NStr("en='Products and services ""%Description%"" in line %LineNumber% are specified again.';
								|ru='Номенклатура ""%Description%"" в строке %LineNumber%, указана повторно.'");
