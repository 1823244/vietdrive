...
Procedure OnOpen(Cancel)
	...
	Items.CounterpartyPriceKindList.Check = (Object.CounterpartyPriceKind.Count() > 0);
	ChangeFilterPage("CounterpartyPriceKind", Items.CounterpartyPriceKindList.Check);
...
Procedure PricesKindList(Command)
	...
	Items.CounterpartyPriceKindList.Check = Not Items.CounterpartyPriceKindList.Check;
	
	If ValueIsFilled(CounterpartyPriceKind) 
		AND Items.CounterpartyPriceKindList.Check Then
...
Procedure DecorationMultipleFilterCouterpartyPriceKindsClick(Item)
	...
	Else
		...
		OpenForm("Catalog.CounterpartyPriceKind.Form.QuickChoiceForm", New Structure("MultipleChoice", True), ThisForm);
...
Procedure OK(Command)
	...
	ParameterValue = ?(Items.CounterpartyPriceKindList.Check, FillArrayByTabularSectionAtClient("CounterpartyPriceKind"), CounterpartyPriceKind);
