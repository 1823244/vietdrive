...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	FormTitle = NStr("en='Configure handler debugging on data %Event%';ru='Настройка отладки обработчиков при %Event% данных'");	
	...
	ButtonTitle = NStr("en='Generate %Event% debug engine';ru='Сформировать модуль отладки %Event%'");
