...
Function CancellationUncheckFunctionalOptionUseWorkSubsystem()
	...
	If Not QueryResult.IsEmpty() Then
		...
		ErrorText = NStr("en='There are documents of the ""Work order"" kind in the infobase. You cannot clear the ""Works"" check box.';ru='В информационной базе присутствуют документы ""Заказ - наряд""! Снятие флага ""Работы"" запрещено!'");
