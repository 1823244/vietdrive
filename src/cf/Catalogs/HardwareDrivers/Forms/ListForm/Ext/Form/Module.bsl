...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	List.QueryText = StrReplace(List.QueryText, "%Predefined%", NStr("en='Supplied with Aplication';ru='Поставляемый в составе Конфигурации'"));
	List.QueryText = StrReplace(List.QueryText, "%Attachable%", NStr("en='Connected according to the 1C:Compatible standard';
																	|ru='Подключаемый по стандарту """"1С:Совместимо""""'"));
