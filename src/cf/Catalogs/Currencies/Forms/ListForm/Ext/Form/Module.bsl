...
Procedure CurrenciesBeforeAddRow(Item, Cancel, Copy, Parent, Group)
	...
	SelectionButtons.Add(DialogReturnCode.Yes, NStr("en = 'Pick'; ru = 'Выбрать'"));
	SelectionButtons.Add(DialogReturnCode.No, NStr("en = 'Create'; ru = 'Создать'"));
	SelectionButtons.Add(DialogReturnCode.Cancel, NStr("en = 'Cancel'; ru = 'Отмена'"));
