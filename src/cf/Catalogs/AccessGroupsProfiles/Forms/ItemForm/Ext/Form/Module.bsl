...
Function QuestionTextUpdateProfileAccessGroups()
	...
	Return
		...
		|
		|Excess access kinds with specified access values
		|will be deleted, and missing access kinds will be added.';
		|ru='Обновить группы доступа, использующие этот профиль?
		|
