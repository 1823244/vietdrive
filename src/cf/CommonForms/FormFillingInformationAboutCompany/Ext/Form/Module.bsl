...
Procedure SetActivePage()
	...
	ThisForm.Title = StringFunctionsClientServer.SubstituteParametersInString(
		NStr("en = 'Company information filling wizard (Step %1/%2)'; ru = 'Помощник заполнения информации об организации (Шаг %1/%2)'"),
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Company.Description = NStr("en = 'LLC ""Our company"";'ru = 'ООО ""Наша фирма""'") Then
		Company.Description = "";
	EndIf;
