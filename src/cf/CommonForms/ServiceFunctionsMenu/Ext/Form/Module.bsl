...
Procedure UpdateOrderStages()
	...
	|		AND DocumentCustomerOrder.OperationKind = VALUE(Enum.OperationKindsCustomerOrder.WorkOrder)
	...
	|					AND InvoiceForPayment.OperationKind = VALUE(Enum.OperationKindsCustomerOrder.WorkOrder)
...
Procedure NotificationProcessing(EventName, Parameter, Source)
	...
	If EventName = "NotificationAboutOrderPayment" 
		...
		OR EventName = "ChangedWorkOrder" Then
		UpdateOrderStages();
	EndIf;
...
// Procedure for opening the selection form with the an option to create new "Work order"
// 
//
&AtClient
...
Procedure OpenNewOrdersClick(Item)
	...
	OpenForm("Document.CustomerOrder.ListForm", OpenParameters, , "WorkOrderDocumentsListFormStageNew");
...
Procedure OpenBackloggedOrders(Item)
	...
	OpenParameters.Insert("WorkOrder", True);
	OpenParameters.Insert("Responsible", Responsible);
	OpenForm("Document.CustomerOrder.ListForm", OpenParameters, , "WorkOrderDocumentsListFormStageNotShipped");
...
Procedure PictureUnpaidClick(Item)
	...
	If Items.Find("LabelPayByOrders") = Undefined Then
		...
		OpenForm("Document.CustomerOrder.ListForm", OpenParameters, , "WorkOrderDocumentsListFormStageUnpaid");
	Else
		OpenParameters.Insert("OperationKindWorkOrder", True);
...
//
&AtClient
Procedure OpenUnpaidWorkOrdersClick(Item)
...
EndProcedure // OpenUnpaidWorkOrdersClick()
