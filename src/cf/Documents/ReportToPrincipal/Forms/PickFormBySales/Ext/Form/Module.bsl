...
Function PlaceInventoryToStorage()
	...
	Inventory = InventoryTable.Unload(, "Selected, ProductsAndServices, Characteristic, Batch, CustomerOrder, PurchaseOrder, Customer, DateOfSale, Quantity, Balance, Price, Amount, ReceiptPrice");
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	FilterCompany = Parameters.SubsidiaryCompany;
