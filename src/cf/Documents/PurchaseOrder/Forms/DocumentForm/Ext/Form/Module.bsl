...
Procedure SetVisibleAndEnabled()
	...
	If Object.OperationKind = PredefinedValue("Enum.OperationKindsPurchaseOrder.OrderForPurchase") Then
		...
		Items.GroupInventory.Title = NStr("en = 'Products and services'; ru = 'Товары и услуги'");
	...
	Else
		...
		Items.GroupInventory.Title = NStr("en = 'Products'; ru = 'Товары'");
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Constants.UsePurchaseOrderStates.Get() Then
		...
		Items.Status.ChoiceList.Add("InProcess", NStr("en = 'In process'; ru = 'В работе'"));
		Items.Status.ChoiceList.Add("Completed", NStr("en = 'Completed'; ru = 'Выполнен'"));
		Items.Status.ChoiceList.Add("Canceled", NStr("en = 'Canceled'; ru = 'Отменен'"));
