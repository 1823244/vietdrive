...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.Property("SelectWorkOrder")
		AND Parameters.SelectWorkOrder Then
		Parameters.Filter.Insert("OperationKind", Enums.OperationKindsCustomerOrder.WorkOrder);
	EndIf;
