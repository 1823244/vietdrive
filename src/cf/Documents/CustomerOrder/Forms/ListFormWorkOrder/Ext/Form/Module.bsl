...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	SmallBusinessClientServer.SetListFilterItem(List,"OperationKind",PredefinedValue("Enum.OperationKindsCustomerOrder.WorkOrder"));
...
Procedure CreateCustomerOrder(Command)
	...
	OpenForm("Document.CustomerOrder.ObjectForm", OpenParameters, Items.List, "NewWorkOrder");
...
Procedure FilterCounterpartyOnChange(Item)
	...
	// StandardSubsystems.PerformanceEstimation
	PerformanceEstimationClientServer.StartTimeMeasurement("DocumentsListWorkOrderFilterCounterparty");
	// End StandardSubsystems.PerformanceEstimation
...
Procedure ListBeforeAddRow(Item, Cancel, Copy, Parent, Group)
	...
	KeyOperation = "WorkOrderFormCreating";
...
Procedure ListBeforeRowChange(Item, Cancel)
	...
	KeyOperation = "WorkOrderFormOpening";
	PerformanceEstimationClientServer.StartTimeMeasurement(KeyOperation);
