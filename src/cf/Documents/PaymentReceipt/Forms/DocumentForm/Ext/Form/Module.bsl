...
Procedure SetChoiceParameterLinksAvailableTypes()
	...
	If Object.OperationKind = PredefinedValue("Enum.OperationKindsPaymentReceipt.FromCustomer") Then
		...
		Items.PaymentDetailsDocument.ToolTip = NStr("en='Paid document of shipment of goods, works and services to a counterparty';
			|ru = 'Оплачиваемый документ отгрузки товаров, работ и услуг контрагенту'");
