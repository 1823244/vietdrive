...
Procedure Filling(FillingData, StandardProcessing)
	...
	If TypeOf(FillingData) = Type("DocumentRef.CustomerOrder") Then
		If FillingData.OperationKind = Enums.OperationKindsCustomerOrder.WorkOrder Then
			Raise NStr("en='You cannot enter Processing report based on the work order.';ru='Нельзя ввести Отчет о переработке на основании заказ-наряда!'");;
		EndIf;
